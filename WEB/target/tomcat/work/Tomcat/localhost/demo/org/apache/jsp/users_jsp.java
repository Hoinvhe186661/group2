 ...
 * Generated at: 2025-11-14 10:27:30 UTC
...
public final class users_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (end < totalPages) { 
      ...
      out.write("        var adminOptionHtml = '<option value=\"admin\">Quản trị viên</option>'; // Lưu lại option admin ban đầu\r\n");
      out.write("\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        // Ẩn/hiện option admin trong dropdown vai trò\r\n");
      out.write("        function toggleAdminOption(show) {\r\n");
      out.write("            var $adminOption = $('#role option[value=\"admin\"]');\r\n");
      out.write("            if (show) {\r\n");
      out.write("                // Hiện option admin nếu chưa có\r\n");
      out.write("                if ($adminOption.length === 0) {\r\n");
      out.write("                    // Khôi phục lại option admin (thêm sau option đầu tiên)\r\n");
      out.write("                    $('#role option:first').after(adminOptionHtml);\r\n");
      out.write("                }\r\n");
      out.write("            } else {\r\n");
      out.write("                // Ẩn option admin bằng cách remove\r\n");
      out.write("                if ($adminOption.length > 0) {\r\n");
      out.write("                    $adminOption.remove();\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("            \r\n");
      out.write("            // Không cho phép sửa vai trò nếu là quản trị viên\r\n");
      out.write("            if (user.role === 'admin') {\r\n");
      out.write("                $('#role').prop('disabled', true).addClass('bg-gray-light');\r\n");
      out.write("                // Giữ lại option admin nếu người dùng đang là admin\r\n");
      out.write("                toggleAdminOption(true);\r\n");
      out.write("            } else {\r\n");
      out.write("                $('#role').prop('disabled', false).removeClass('bg-gray-light');\r\n");
      out.write("                // Ẩn option admin khi chỉnh sửa các vai trò khác (trừ admin ra)\r\n");
      out.write("                toggleAdminOption(false);\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      ...
      out.write("            // Enable lại trường role khi đóng modal\r\n");
      out.write("            $('#role').prop('disabled', false).removeClass('bg-gray-light');\r\n");
      out.write("            // Hiện lại option admin khi đóng modal (để có thể chọn khi thêm mới)\r\n");
      out.write("            toggleAdminOption(true);\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      ...
      out.write("                // Hiện option admin khi thêm mới\r\n");
      out.write("                toggleAdminOption(true);\r\n");
      out.write("            } else {\r\n");
      out.write("                $('#passwordGroup').hide();\r\n");
      out.write("                $('#password').prop('required', false).val('');\r\n");
      out.write("                // Logic ẩn/hiện option admin được xử lý trong populateEditForm\r\n");
      out.write("                // Dựa vào vai trò của người dùng đang chỉnh sửa\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
