 ...
 * Generated at: 2025-11-15 03:02:02 UTC
...
public final class stock_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (!canManage) {
      ...
      out.write("                                            <th style=\"text-align: center;\">Đã giữ chỗ</th>\r\n");
      out.write("                                            <th style=\"text-align: center;\">Tổng kho</th>\r\n");
      out.write("                                            <th style=\"text-align: center;\">Tổng đang cần</th>\r\n");
      out.write("                                            <th style=\"text-align: center;\">Còn thiếu</th>\r\n");
      ...
      out.write("                                    <tbody>\r\n");
      out.write("                                        <tr>\r\n");
      out.write("                                            <td colspan=\"12\" class=\"text-center\">\r\n");
      ...
      out.write("            $('#stockTable tbody').html('<tr><td colspan=\"12\" class=\"text-center\"><i class=\"fa fa-spinner fa-spin\"></i> Đang tải dữ liệu...</td></tr>');\r\n");
      out.write("            \r\n");
      out.write("            $.ajax({\r\n");
      out.write("                url: '");
      out.print(request.getContextPath());
      ...
      out.write("                    } else {\r\n");
      out.write("                        $('#stockTable tbody').html('<tr><td colspan=\"12\" class=\"text-center\"><div class=\"alert alert-warning\">Không có dữ liệu tồn kho</div></td></tr>');\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      out.write("                error: function(xhr, status, error) {\r\n");
      out.write("                    console.error('Error loading stock data:', error);\r\n");
      out.write("                    $('#stockTable tbody').html('<tr><td colspan=\"12\" class=\"text-center\"><div class=\"alert alert-danger\">Lỗi khi tải dữ liệu: ' + error + '</div></td></tr>');\r\n");
      out.write("                }\r\n");
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("                tbody.html('<tr><td colspan=\"12\" class=\"text-center\"><div class=\"alert alert-info\">Không có dữ liệu tồn kho</div></td></tr>');\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      ...
      out.write("                \r\n");
      out.write("                // Tính toán các giá trị\r\n");
      out.write("                var reservedStock = Number(item.reservedStock || 0);\r\n");
      out.write("                var totalStock = Number(item.totalStock || 0);\r\n");
      out.write("                var totalRequired = Number(item.totalRequired || 0);\r\n");
      out.write("                var shortage = Number(item.shortage || 0);\r\n");
      out.write("                \r\n");
      out.write("                // Tổng kho = Tổng tồn kho hiện có (totalStock)\r\n");
      out.write("                // Lưu ý: reservedStock đã nằm trong totalStock rồi, không cộng lại\r\n");
      out.write("                // totalStock = SUM(current_stock) đã bao gồm cả phần đã giữ chỗ\r\n");
      out.write("                var totalInventory = totalStock;\r\n");
      out.write("                \r\n");
      out.write("                // Format hiển thị số thiếu: >0 màu đỏ, =0 màu xanh\r\n");
      out.write("                var shortageDisplay = shortage.toLocaleString();\r\n");
      out.write("                var shortageClass = shortage > 0 ? 'text-danger' : 'text-success';\r\n");
      out.write("                \r\n");
      ...
      out.write("                row += '<td style=\"text-align: center;\"><strong>' + reservedStock.toLocaleString() + '</strong></td>';\r\n");
      out.write("                row += '<td style=\"text-align: center;\"><strong class=\"text-primary\">' + totalInventory.toLocaleString() + '</strong></td>';\r\n");
      out.write("                row += '<td style=\"text-align: center;\"><strong>' + totalRequired.toLocaleString() + '</strong></td>';\r\n");
      out.write("                row += '<td style=\"text-align: center;\"><strong class=\"' + shortageClass + '\">' + shortageDisplay + '</strong></td>';\r\n");
