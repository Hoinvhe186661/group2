 ...
 * Generated at: 2025-10-18 15:59:55 UTC
...
public final class tech_005fsupport_005fmanagement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (!"head_technician".equals(userRole) && !"admin".equals(userRole)) {
      ...
      out.write("                            <div class=\"col-sm-9\">\n");
      out.write("                                <textarea class=\"form-control\" id=\"detail_resolution\" rows=\"3\" placeholder=\"Nhập giải pháp kỹ thuật...\"></textarea>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        \n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label class=\"col-sm-3 control-label\">Ghi chú kỹ thuật:</label>\n");
      out.write("                            <div class=\"col-sm-9\">\n");
      out.write("                                <textarea class=\"form-control\" id=\"detail_notes\" rows=\"2\" placeholder=\"Ghi chú cho nhân viên kỹ thuật...\"></textarea>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
      ...
      out.write("                            <label class=\"col-sm-3 control-label\">Tiêu đề:</label>\n");
      out.write("                            <div class=\"col-sm-9\">\n");
      out.write("                                <p class=\"form-control-static\" id=\"work_order_subject\"></p>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        \n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <label class=\"col-sm-3 control-label\">Độ ưu tiên:</label>\n");
      out.write("                            <div class=\"col-sm-9\">\n");
      out.write("                                <select class=\"form-control\" id=\"work_order_priority\" required>\n");
      out.write("                                    <option value=\"urgent\">Khẩn cấp</option>\n");
      out.write("                                    <option value=\"high\">Cao</option>\n");
      out.write("                                    <option value=\"medium\">Trung bình</option>\n");
      out.write("                                    <option value=\"low\">Thấp</option>\n");
      ...
      out.write("                            <div class=\"col-sm-9\">\n");
      out.write("                                <textarea class=\"form-control\" id=\"work_order_description\" rows=\"3\" placeholder=\"Mô tả chi tiết công việc cần thực hiện...\" required></textarea>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        \n");
      out.write("                        <div class=\"form-group\">\n");
      ...
      out.write("                            <div class=\"col-sm-9\">\n");
      out.write("                                <input type=\"number\" class=\"form-control\" id=\"work_order_estimated_hours\" step=\"0.5\" min=\"0\" placeholder=\"Số giờ ước tính\">\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        \n");
      out.write("                    </form>\n");
      ...
      out.write("            // Chỉ load ticket được chuyển tiếp (assignedTo = 'head_technician')\n");
      ...
      out.write("            ];\n");
      out.write("            \n");
      out.write("            // Lọc chỉ những ticket được gán cho head_technician\n");
      out.write("            allTickets = allTickets.filter(function(ticket) {\n");
      out.write("                return ticket.assignedTo === 'head_technician';\n");
      out.write("            });\n");
      out.write("            \n");
      out.write("            filteredTickets = allTickets;\n");
      out.write("            renderTable();\n");
      ...
      out.write("            \n");
      out.write("            // Phân quyền hiển thị nút và chỉnh sửa\n");
      out.write("            if (userRole === 'head_technician' || userRole === 'admin') {\n");
      out.write("                $('#btnSaveTicket').show();\n");
      out.write("                $('#detail_category, #detail_priority, #detail_status, #detail_resolution, #detail_notes').prop('readonly', false);\n");
      out.write("            } else {\n");
      out.write("                $('#btnSaveTicket').hide();\n");
      out.write("                $('#detail_category, #detail_priority, #detail_status, #detail_resolution, #detail_notes').prop('readonly', true);\n");
      out.write("            }\n");
      out.write("            \n");
      ...
      out.write("            $('#work_order_subject').text(ticket.subject || '');\n");
      out.write("            $('#work_order_priority').val(ticket.priority || 'medium');\n");
      ...
      out.write("                priority: $('#work_order_priority').val(),\n");
      out.write("                description: $('#work_order_description').val(),\n");
      out.write("                estimatedHours: $('#work_order_estimated_hours').val()\n");
      out.write("            };\n");
      out.write("            \n");
      out.write("            $.ajax({\n");
