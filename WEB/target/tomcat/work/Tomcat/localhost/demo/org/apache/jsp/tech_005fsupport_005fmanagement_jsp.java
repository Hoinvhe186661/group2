 ...
 * Generated at: 2025-11-05 16:11:10 UTC
...
public final class tech_005fsupport_005fmanagement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (!"head_technician".equals(userRole) && !"admin".equals(userRole)) {
      ...
      out.write("                                    <button type=\"button\" class=\"btn btn-success btn-sm\" id=\"btnManualRefresh\" title=\"Tải lại danh sách\">\n");
      out.write("                                        <i class=\"fa fa-refresh\"></i> Tải lại\n");
      out.write("                                    </button>\n");
      out.write("                                    <span class=\"label label-info\" id=\"autoRefreshStatus\" style=\"margin-left: 10px; font-size: 11px;\" title=\"Tự động cập nhật mỗi 30 giây\">\n");
      out.write("                                        <i class=\"fa fa-clock-o\"></i> Auto-refresh\n");
      out.write("                                    </span>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      ...
      out.write("            });\n");
      out.write("            \n");
      out.write("            // Manual refresh button\n");
      out.write("            $('#btnManualRefresh').click(function() {\n");
      out.write("                var $btn = $(this);\n");
      out.write("                $btn.prop('disabled', true).html('<i class=\"fa fa-spinner fa-spin\"></i> Đang tải...');\n");
      out.write("                loadTickets(false); // false = not silent, show notifications\n");
      out.write("                setTimeout(function() {\n");
      out.write("                    $btn.prop('disabled', false).html('<i class=\"fa fa-refresh\"></i> Tải lại');\n");
      out.write("                }, 1000);\n");
      out.write("            });\n");
      out.write("        });\n");
      out.write("        \n");
      ...
      out.write("                        var previousResolvedCount = allTickets.filter(function(t) { return t.status === 'resolved'; }).length;\n");
      out.write("                        \n");
      out.write("                        // Tất cả ticket đã được lọc ở backend (chỉ technical)\n");
      out.write("                        var newTickets = response.data || [];\n");
      out.write("                        var newResolvedCount = newTickets.filter(function(t) { return t.status === 'resolved'; }).length;\n");
      out.write("                        \n");
