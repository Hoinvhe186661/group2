 ...
 * Generated at: 2025-11-12 05:53:17 UTC
...
public final class tech_005fsupport_005fmanagement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (userPermissions == null || !userPermissions.contains("manage_tech_support_requests")) {
      ...
      out.write("                        \r\n");
      out.write("                        <div class=\"form-group\">\r\n");
      out.write("                            <label class=\"col-sm-3 control-label\">Ngày thực hiện:</label>\r\n");
      out.write("                            <div class=\"col-sm-9\">\r\n");
      out.write("                                <input type=\"date\" class=\"form-control\" id=\"work_order_scheduled_date\" min=\"\">\r\n");
      out.write("                                <small class=\"help-block\">Ngày thực hiện công việc (không được chọn ngày quá khứ và phải nhỏ hơn hoặc bằng ngày mong muốn hoàn thành)</small>\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        \r\n");
      out.write("                    </form>\r\n");
      ...
      out.write("            \r\n");
      out.write("            // Set minimum date for scheduled date input (today)\r\n");
      out.write("            setMinDateForScheduledDate();\r\n");
      out.write("            \r\n");
      ...
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("            // Validate scheduled date when modal is shown\r\n");
      out.write("            $('#createWorkOrderModal').on('shown.bs.modal', function() {\r\n");
      out.write("                setMinDateForScheduledDate();\r\n");
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("            // Validate scheduled date on change\r\n");
      out.write("            $('#work_order_scheduled_date').on('change', function() {\r\n");
      out.write("                validateScheduledDate();\r\n");
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("        });\r\n");
      out.write("        \r\n");
      out.write("        function setMinDateForScheduledDate() {\r\n");
      ...
      out.write("            $('#work_order_scheduled_date').attr('min', todayStr);\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function validateScheduledDate() {\r\n");
      out.write("            var scheduledDate = $('#work_order_scheduled_date').val();\r\n");
      out.write("            if (scheduledDate) {\r\n");
      out.write("                var selectedDate = new Date(scheduledDate);\r\n");
      out.write("                var today = new Date();\r\n");
      out.write("                today.setHours(0, 0, 0, 0); // Reset time to 00:00:00\r\n");
      out.write("                selectedDate.setHours(0, 0, 0, 0);\r\n");
      out.write("                \r\n");
      out.write("                // Kiểm tra không được là ngày quá khứ\r\n");
      out.write("                if (selectedDate < today) {\r\n");
      out.write("                    alert('⚠ Lỗi: Ngày thực hiện không được là ngày quá khứ. Vui lòng chọn ngày hôm nay hoặc ngày trong tương lai.');\r\n");
      out.write("                    $('#work_order_scheduled_date').val('');\r\n");
      out.write("                    $('#work_order_scheduled_date').focus();\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                // Kiểm tra ngày thực hiện <= deadline\r\n");
      out.write("                var deadlineValue = $('#work_order_scheduled_date').data('deadline');\r\n");
      out.write("                if (deadlineValue) {\r\n");
      out.write("                    try {\r\n");
      out.write("                        // Deadline đã được lưu dạng yyyy-MM-dd\r\n");
      out.write("                        var deadlineDate = new Date(deadlineValue);\r\n");
      out.write("                        deadlineDate.setHours(0, 0, 0, 0);\r\n");
      out.write("                        \r\n");
      out.write("                        if (selectedDate > deadlineDate) {\r\n");
      out.write("                            // Format deadline để hiển thị trong thông báo\r\n");
      out.write("                            var deadlineParts = deadlineValue.split('-');\r\n");
      out.write("                            var deadlineDisplay = deadlineParts[2] + '/' + deadlineParts[1] + '/' + deadlineParts[0];\r\n");
      out.write("                            alert('⚠ Lỗi: Ngày thực hiện không được lớn hơn ngày mong muốn hoàn thành (' + deadlineDisplay + '). Vui lòng chọn ngày nhỏ hơn hoặc bằng ngày mong muốn hoàn thành.');\r\n");
      out.write("                            $('#work_order_scheduled_date').val('');\r\n");
      out.write("                            $('#work_order_scheduled_date').focus();\r\n");
      out.write("                            return false;\r\n");
      out.write("                        }\r\n");
      out.write("                    } catch (e) {\r\n");
      out.write("                        console.warn('Không thể parse deadline:', e);\r\n");
      out.write("                    }\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      ...
      out.write("            // Hiển thị deadline - format từ yyyy-MM-dd sang dd/MM/yyyy\r\n");
      out.write("            var deadlineDisplay = '';\r\n");
      out.write("            var deadlineDateValue = null; // Lưu deadline dạng Date object để validate\r\n");
      out.write("            if (ticket.deadline && typeof ticket.deadline === 'string' && ticket.deadline.trim() !== '' && ticket.deadline !== 'null') {\r\n");
      out.write("                try {\r\n");
      out.write("                    // Deadline từ DB là yyyy-MM-dd, chuyển sang dd/MM/yyyy\r\n");
      out.write("                    var deadlineStr = ticket.deadline.trim();\r\n");
      ...
      out.write("                        var parts = deadlineStr.split('-');\r\n");
      out.write("                        deadlineDisplay = parts[2] + '/' + parts[1] + '/' + parts[0];\r\n");
      out.write("                        // Lưu deadline dạng yyyy-MM-dd vào data attribute để validate\r\n");
      out.write("                        deadlineDateValue = deadlineStr;\r\n");
      out.write("                    } else {\r\n");
      out.write("                        deadlineDisplay = deadlineStr;\r\n");
      out.write("                    }\r\n");
      out.write("                } catch (e) {\r\n");
      ...
      out.write("            // Lưu deadline vào data attribute để validate\r\n");
      out.write("            if (deadlineDateValue) {\r\n");
      out.write("                $('#work_order_scheduled_date').data('deadline', deadlineDateValue);\r\n");
      out.write("            } else {\r\n");
      out.write("                $('#work_order_scheduled_date').removeData('deadline');\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            $('#work_order_estimated_hours').val('');\r\n");
      out.write("            $('#work_order_scheduled_date').val('');\r\n");
      out.write("            \r\n");
      out.write("            // Set minimum date when opening modal\r\n");
      out.write("            setMinDateForScheduledDate();\r\n");
      out.write("            \r\n");
      ...
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            // Validate scheduled date before submitting\r\n");
      out.write("            if (!validateScheduledDate()) {\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
