 ...
 * Generated at: 2025-11-15 03:04:12 UTC
...
public final class inventory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (!canManage && !canView) {
      ...
      out.write("                                        <div class=\"row\">\r\n");
      out.write("                                            <!-- Lọc theo trạng thái hợp đồng - Ẩn vì chỉ hiển thị hợp đồng hiệu lực -->\r\n");
      out.write("                                            <div class=\"col-md-3\" style=\"display: none;\">\r\n");
      ...
      out.write("                                                        <option value=\"active\" selected>Hiệu Lực</option>\r\n");
      ...
      out.write("                                            <th>Trạng thái bàn giao</th>\r\n");
      ...
      out.write("                                            <th style=\"width: 200px;\">Tên sản phẩm</th>\r\n");
      out.write("                                            <th style=\"width: 100px;\">Đơn vị</th>\r\n");
      out.write("                                            <th style=\"width: 120px;\">Còn thiếu</th>\r\n");
      ...
      out.write("            // Set mặc định filter trạng thái là \"active\" (hiệu lực)\r\n");
      out.write("            $('#filterContractStatus').val('active');\r\n");
      ...
      out.write("                var deliveryBadge = getContractDeliveryBadge(contract.deliveryStatus, contract.deliveredProducts || 0, contract.totalProducts || 0);\r\n");
      ...
      out.write("                var isFullyDelivered = contract.fullyDelivered === true;\r\n");
      out.write("                \r\n");
      ...
      out.write("                if ((contractStatus === 'draft' || contractStatus === 'active') && !isFullyDelivered) {\r\n");
      ...
      out.write("                        '<i class=\"fa fa-arrow-up\"></i> Xuất kho' +\r\n");
      out.write("                    '</button>';\r\n");
      out.write("                } else if (isFullyDelivered) {\r\n");
      out.write("                    actionButtons += ' <span class=\"label label-success\" style=\"display: inline-block; margin-left: 5px;\" title=\"Hợp đồng đã bàn giao đầy đủ\">Đã xuất</span>';\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      ...
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function getContractDeliveryBadge(status, deliveredCount, totalCount) {\r\n");
      out.write("            var normalized = (status || '').toLowerCase();\r\n");
      out.write("            var badgeClass = 'label-default';\r\n");
      out.write("            var label = 'Không có sản phẩm';\r\n");
      out.write("            \r\n");
      out.write("            if (normalized === 'delivered') {\r\n");
      out.write("                badgeClass = 'label-success';\r\n");
      out.write("                label = 'Đã bàn giao';\r\n");
      out.write("            } else if (normalized === 'partial') {\r\n");
      out.write("                badgeClass = 'label-warning';\r\n");
      out.write("                label = 'Đang bàn giao';\r\n");
      out.write("            } else if (normalized === 'not_delivered') {\r\n");
      out.write("                badgeClass = 'label-default';\r\n");
      out.write("                label = 'Chưa bàn giao';\r\n");
      out.write("            } else if (normalized === 'no_products') {\r\n");
      out.write("                badgeClass = 'label-default';\r\n");
      out.write("                label = 'Không có sản phẩm';\r\n");
      out.write("            } else {\r\n");
      out.write("                label = 'Không xác định';\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            if (totalCount > 0) {\r\n");
      out.write("                label += ' (' + deliveredCount + '/' + totalCount + ')';\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            return '<span class=\"label ' + badgeClass + '\">' + label + '</span>';\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function getProductDeliveryBadge(status) {\r\n");
      out.write("            var normalized = (status || '').toLowerCase();\r\n");
      out.write("            if (normalized === 'delivered') {\r\n");
      out.write("                return '<span class=\"label label-success\"><i class=\"fa fa-check\"></i> Đã bàn giao</span>';\r\n");
      out.write("            }\r\n");
      out.write("            if (normalized === 'partial') {\r\n");
      out.write("                return '<span class=\"label label-warning\"><i class=\"fa fa-exclamation\"></i> Đang bàn giao</span>';\r\n");
      out.write("            }\r\n");
      out.write("            return '<span class=\"label label-default\"><i class=\"fa fa-clock-o\"></i> Chưa bàn giao</span>';\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      ...
      out.write("                        var deliveryBadge = getContractDeliveryBadge(data.overallDeliveryStatus, data.deliveredProducts || 0, data.totalProducts || 0);\r\n");
      out.write("                        \r\n");
      ...
      out.write("                            productsHtml = '<tr><td colspan=\"6\" class=\"text-center text-muted\">Hợp đồng chưa có sản phẩm</td></tr>';\r\n");
      out.write("                        } else {\r\n");
      out.write("                            products.forEach(function(product, index) {\r\n");
      out.write("                                var isAvailable = product.available === true;\r\n");
      out.write("                                var deliveryStatus = (product.deliveryStatus || '').toLowerCase();\r\n");
      out.write("                                var isDelivered = deliveryStatus === 'delivered';\r\n");
      ...
      out.write("                                var highlightShortage = !isDelivered && !isAvailable;\r\n");
      out.write("\r\n");
      out.write("                                if (highlightShortage) {\r\n");
      ...
      out.write("                                }\r\n");
      out.write("                                \r\n");
      out.write("                                var handoverBadge = getProductDeliveryBadge(product.deliveryStatus);\r\n");
      out.write("                                \r\n");
      out.write("                                // Màu nền cho hàng không đủ\r\n");
      out.write("                                var rowClass = highlightShortage ? 'danger' : '';\r\n");
      out.write("                                var rowStyle = highlightShortage ? 'background-color: #f2dede;' : '';\r\n");
      out.write("                                \r\n");
      out.write("                                var rowHtml = '<tr class=\"' + rowClass + '\" style=\"' + rowStyle + '\">' +\r\n");
      ...
      out.write("                                    '<td style=\"text-align: right;\"><strong>' + requiredQty + '</strong>' +\r\n");
      out.write("                                        (highlightShortage ? '<br/><small class=\"text-danger\">Thiếu: <strong>' + shortage + '</strong></small>' : '') +\r\n");
      out.write("                                    '</td>' +\r\n");
      out.write("                                    '<td style=\"text-align: center;\">' + handoverBadge + '</td>' +\r\n");
      out.write("                                '</tr>';\r\n");
      out.write("                                \r\n");
      out.write("                                productsHtml += rowHtml;\r\n");
      out.write("                            });\r\n");
      out.write("                        }\r\n");
      out.write("                        \r\n");
      ...
      out.write("                                '<p><strong>Trạng thái bàn giao:</strong> ' + deliveryBadge + '</p>' +\r\n");
      out.write("                            '</div>' +\r\n");
      out.write("                        '</div>' +\r\n");
      out.write("                        '<hr/>' +\r\n");
      ...
      out.write("                                        '<th style=\"text-align: center;\">Bàn giao</th>' +\r\n");
      out.write("                                    '</tr>' +\r\n");
      out.write("                                '</thead>' +\r\n");
      ...
      out.write("        // Biến lưu contractId khi đang xuất từ hợp đồng cụ thể\r\n");
      out.write("        var lockedContractId = null;\r\n");
      out.write("        \r\n");
      ...
      out.write("            \r\n");
      out.write("            // Set flag và lock contract ID\r\n");
      out.write("            isExportingFromContract = true;\r\n");
      out.write("            lockedContractId = contractId;\r\n");
      out.write("            \r\n");
      ...
      out.write("                        \r\n");
      out.write("                        // Disable dropdown hợp đồng khi đang xuất từ hợp đồng cụ thể\r\n");
      out.write("                        if (lockedContractId) {\r\n");
      out.write("                            contractSelect.prop('disabled', true);\r\n");
      out.write("                            contractSelect.css('background-color', '#f5f5f5');\r\n");
      out.write("                            contractSelect.attr('title', 'Đang xuất kho cho hợp đồng này, không thể thay đổi');\r\n");
      out.write("                        }\r\n");
      out.write("                        \r\n");
      ...
      out.write("            \r\n");
      out.write("            // Tính còn thiếu = số lượng cần - tổng tồn kho\r\n");
      out.write("            var requiredQty = parseFloat(product.quantity) || 0;\r\n");
      out.write("            var totalStock = product.totalStock || 0;\r\n");
      out.write("            var shortage = requiredQty - totalStock; // Còn thiếu\r\n");
      out.write("            \r\n");
      out.write("            // Tìm tồn kho tại warehouse được chọn để hiển thị thông tin\r\n");
      out.write("            var stockAtWarehouse = 0;\r\n");
      out.write("            var reservedAtWarehouse = 0;\r\n");
      out.write("            if (product.stocks && product.stocks.length > 0) {\r\n");
      out.write("                var stockInfo = product.stocks.find(function(s) {\r\n");
      out.write("                    return s.warehouse === warehouse;\r\n");
      out.write("                });\r\n");
      out.write("                if (stockInfo) {\r\n");
      out.write("                    stockAtWarehouse = stockInfo.stock || 0;\r\n");
      out.write("                    reservedAtWarehouse = stockInfo.reserved || 0;\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("            var stockTitle = 'Cần: ' + requiredQty + ' | Tổng tồn: ' + totalStock + ' | Tại kho này: ' + stockAtWarehouse + ' | Giữ chỗ: ' + reservedAtWarehouse;\r\n");
      out.write("            \r\n");
      out.write("            // Màu sắc: nếu còn thiếu <= 0 thì có thể xuất (màu xanh), nếu > 0 thì thiếu (màu đỏ)\r\n");
      out.write("            var shortageColor = shortage <= 0 ? 'color: #5cb85c;' : 'color: #d9534f;';\r\n");
      out.write("            // Hiển thị: nếu <= 0 thì hiển thị 0 (đủ hàng), nếu > 0 thì hiển thị số thiếu\r\n");
      out.write("            var shortageDisplay = shortage <= 0 ? '0' : shortage;\r\n");
      out.write("            \r\n");
      ...
      out.write("                '</td>' +\r\n");
      out.write("                '<td style=\"text-align: center; vertical-align: middle;\">' +\r\n");
      out.write("                    '<span class=\"stockOutCurrentStock\" style=\"font-weight: bold; ' + shortageColor + '\" title=\"' + stockTitle + '\">' + shortageDisplay + '</span>' +\r\n");
      out.write("                '</td>' +\r\n");
      out.write("                '<td>' +\r\n");
      ...
      out.write("                });\r\n");
      out.write("                \r\n");
      out.write("                // Gán sự kiện input cho số lượng - không giới hạn dựa trên available stock\r\n");
      out.write("                // Validation sẽ được thực hiện ở backend\r\n");
      out.write("                $('#' + rowId + ' .stockOutQuantity').off('input').on('input', function() {\r\n");
      out.write("                    var row = $(this).closest('tr');\r\n");
      out.write("                    var quantity = parseInt($(this).val()) || 0;\r\n");
      out.write("                    // Không giới hạn số lượng xuất ở frontend, backend sẽ validate\r\n");
      out.write("                });\r\n");
      out.write("            }, 100);\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      ...
      out.write("                        \r\n");
      out.write("                        // Hiển thị số âm nếu thiếu, màu đỏ\r\n");
      out.write("                        var availableText = available;\r\n");
      out.write("                        var availableClass = available >= 0 ? 'text-success' : 'text-danger';\r\n");
      out.write("                        row.find('.stockOutCurrentStock').text(availableText).attr('title', title).removeClass('text-success text-danger').addClass(availableClass);\r\n");
      out.write("                        \r\n");
      out.write("                        // Cập nhật max cho input số lượng (cho phép nhập nếu available < 0)\r\n");
      out.write("                        if (available < 0) {\r\n");
      out.write("                            row.find('.stockOutQuantity').removeAttr('max');\r\n");
      out.write("                        } else {\r\n");
      ...
      out.write("            $('#filterContractStatus').val('active'); // Mặc định là active\r\n");
      ...
      out.write("            // Reset flag và unlock contract\r\n");
      out.write("            isExportingFromContract = false;\r\n");
      out.write("            lockedContractId = null;\r\n");
      out.write("            \r\n");
      out.write("            // Enable lại dropdown hợp đồng\r\n");
      out.write("            var contractSelect = $('#stockOutContractId');\r\n");
      out.write("            contractSelect.prop('disabled', false);\r\n");
      out.write("            contractSelect.css('background-color', '');\r\n");
      out.write("            contractSelect.removeAttr('title');\r\n");
      out.write("            \r\n");
      ...
      out.write("            // Nếu đang bị lock (xuất từ hợp đồng cụ thể), không cho thay đổi\r\n");
      out.write("            if (lockedContractId) {\r\n");
      out.write("                $(this).val(lockedContractId);\r\n");
      out.write("                alert('Đang xuất kho cho hợp đồng này, không thể chọn hợp đồng khác.');\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
