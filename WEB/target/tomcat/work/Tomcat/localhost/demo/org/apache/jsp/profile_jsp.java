 ...
 * Generated at: 2025-11-03 17:32:21 UTC
...
public final class profile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \r\n");
      out.write("        // Thêm customerId nếu có (từ session hoặc customerData)\r\n");
      out.write("        var customerId = '");
      out.print( String.valueOf(session.getAttribute("customerId")) );
      out.write("';\r\n");
      out.write("        if (customerId && customerId !== 'null') {\r\n");
      out.write("          data.append('customerId', customerId);\r\n");
      out.write("        } else if (customerData && customerData.id) {\r\n");
      out.write("          data.append('customerId', customerData.id);\r\n");
      out.write("        }\r\n");
      out.write("        fetch('");
      out.print(request.getContextPath());
      ...
      out.write("              var addrParts = splitAddress(address);\r\n");
      out.write("              if (document.getElementById('addrStreet')) document.getElementById('addrStreet').value = addrParts.street;\r\n");
      out.write("              if (document.getElementById('addrDistrict')) document.getElementById('addrDistrict').value = addrParts.district;\r\n");
      out.write("              if (document.getElementById('addrCity')) document.getElementById('addrCity').value = addrParts.city;\r\n");
      ...
      out.write("                }).then(function(rr){ return rr.json(); }).then(function(j){\r\n");
      out.write("                  if (j && j.success) {\r\n");
      out.write("                    alert('Cập nhật thành công');\r\n");
      out.write("                  } else {\r\n");
      out.write("                    alert('Cập nhật tài khoản thành công, nhưng cập nhật thông tin khách hàng thất bại: ' + (j && j.message ? j.message : 'Lỗi không xác định'));\r\n");
      out.write("                  }\r\n");
      out.write("                }).catch(function(){ \r\n");
      out.write("                  alert('Cập nhật tài khoản thành công, nhưng cập nhật thông tin khách hàng thất bại. Vui lòng thử lại sau.'); \r\n");
      out.write("                });\r\n");
      out.write("              } else {\r\n");
      out.write("                alert('Cập nhật tài khoản thành công');\r\n");
      out.write("              }\r\n");
      out.write("            } else {\r\n");
      out.write("              // Hiển thị thông báo lỗi chi tiết hơn\r\n");
      out.write("              var errorMsg = (j && j.message) ? j.message : 'Không thể cập nhật';\r\n");
      out.write("              if (errorMsg.includes('Vui lòng chọn khách hàng')) {\r\n");
      out.write("                errorMsg = 'Lỗi: Không tìm thấy thông tin khách hàng. Vui lòng liên hệ quản trị viên để được hỗ trợ.';\r\n");
      out.write("              }\r\n");
