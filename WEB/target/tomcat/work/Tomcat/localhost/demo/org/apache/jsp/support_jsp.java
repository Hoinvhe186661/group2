 ...
 * Generated at: 2025-11-04 01:26:04 UTC
...
public final class support_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (!canAccessSupport) {
      ...
      out.write("      \r\n");
      out.write("      // Validation: Kiểm tra hợp đồng và sản phẩm\r\n");
      ...
      out.write("      const baseDesc = description;\r\n");
      ...
      out.write("      document.getElementById('v_status').textContent = ticketData.status || '';\r\n");
      ...
      out.write("      if (desInp) desInp.value = (ticketData.description||'');\r\n");
      out.write("      const created = formatDate(ticketData);\r\n");
      out.write("      const resolved = (ticketData.resolvedAt ? new Intl.DateTimeFormat('vi-VN', { timeZone: 'Asia/Ho_Chi_Minh' }).format(new Date(ticketData.resolvedAt)) : '');\r\n");
      ...
      out.write("      document.getElementById('v_assigned_to').textContent = ticketData.assignedTo || 'Chưa phân công';\r\n");
      out.write("      document.getElementById('v_history').textContent = ticketData.history || 'Chưa có lịch sử';\r\n");
      ...
      out.write("      attachEditHandlers(ticketData.id, ticketData.status, catInp, priInp, subInp, desInp, vContract, vProduct, enable, saveBtn);\r\n");
      out.write("      }\r\n");
      out.write("      \r\n");
      out.write("      function attachEditHandlers(ticketId, ticketStatus, catInp, priInp, subInp, desInp, vContract, vProduct, enable, saveBtn) {\r\n");
      out.write("      // Kiểm tra trạng thái để quyết định có cho phép chỉnh sửa không\r\n");
