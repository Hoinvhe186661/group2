 ...
 * Generated at: 2025-10-23 23:37:00 UTC
...
public final class support_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (!canAccessSupport) {
      ...
      out.write("    if (createdInput) createdInput.value = todayLocal;\r\n");
      out.write("    try {\r\n");
      ...
      out.write("    let sortDirectionId = true; // true = tăng dần, false = giảm dần\r\n");
      out.write("    let sortDirectionDate = true; // true = tăng dần, false = giảm dần\r\n");
      ...
      out.write("      const term = searchTerm.trim().toLowerCase();\r\n");
      out.write("      filteredItems = allItems.filter(function(item){\r\n");
      out.write("        // text match\r\n");
      out.write("        const textOk = !term || (\r\n");
      ...
      out.write("        );\r\n");
      out.write("        // status match (use final status considering cancelled set)\r\n");
      out.write("        const st = (cancelledItems.has(String(item.id)) ? 'cancelled' : (item.status || 'pending'));\r\n");
      out.write("        const statusOk = !filterStatus || (filterStatus === 'waiting' ? (st === 'open' || st === 'pending') : st === filterStatus);\r\n");
      out.write("        // category match\r\n");
      out.write("        const categoryOk = !filterCategory || (item.category||'').toLowerCase() === filterCategory;\r\n");
      out.write("        return textOk && statusOk && categoryOk;\r\n");
      out.write("      });\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      ...
      out.write("        tr.innerHTML = '<td>'+ sequenceNumber +'</td><td>'+ (it.category||'') +'</td><td>'+ displaySubject +'</td><td>'+ created +'</td><td><span class=\"badge ' + statusClass + '\">' + status + '</span></td><td><a href=\"#\" class=\"view-link me-2\" data-id=\"'+ (it.id||'') +'\">Xem</a> ' + cancelButton + '</td>';\r\n");
      ...
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    // Hàm sắp xếp theo ID\r\n");
      out.write("    function sortById(ascending) {\r\n");
      out.write("      filteredItems.sort((a, b) => {\r\n");
      out.write("        const idA = parseInt(a.id) || 0;\r\n");
      out.write("        const idB = parseInt(b.id) || 0;\r\n");
      out.write("        return ascending ? idA - idB : idB - idA;\r\n");
      out.write("      });\r\n");
      out.write("      renderPage(1);\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    // Hàm sắp xếp theo ngày tạo\r\n");
      out.write("    function sortByDate(ascending) {\r\n");
      out.write("      filteredItems.sort((a, b) => {\r\n");
      out.write("        const dateA = new Date(a.createdDate || a.createdAt || 0);\r\n");
      out.write("        const dateB = new Date(b.createdDate || b.createdAt || 0);\r\n");
      out.write("        return ascending ? dateA - dateB : dateB - dateA;\r\n");
      out.write("      });\r\n");
      out.write("      renderPage(1);\r\n");
      out.write("    }\r\n");
      out.write("    function load(){\r\n");
      out.write("      fetch(ctx + '/api/support-stats?action=list', {headers:{'Accept':'application/json'}})\r\n");
      ...
      out.write("          }\r\n");
      out.write("        })\r\n");
      out.write("        .catch(()=>{tbody.innerHTML='<tr><td colspan=\"6\" class=\"text-center text-danger\"><i class=\"fas fa-exclamation-triangle\"></i> Lỗi kết nối máy chủ</td></tr>';});\r\n");
      out.write("    }\r\n");
      out.write("    load();\r\n");
      out.write("\r\n");
      out.write("    // Thêm event listener cho sắp xếp\r\n");
      out.write("    document.querySelector('th:nth-child(1)').addEventListener('click', function() {\r\n");
      out.write("      sortDirectionId = !sortDirectionId;\r\n");
      out.write("      sortById(sortDirectionId);\r\n");
      out.write("      document.getElementById('sortIdArrow').textContent = sortDirectionId ? ' ↑' : ' ↓';\r\n");
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write("    document.querySelector('th:nth-child(4)').addEventListener('click', function() {\r\n");
      out.write("      sortDirectionDate = !sortDirectionDate;\r\n");
      out.write("      sortByDate(sortDirectionDate);\r\n");
      out.write("      document.getElementById('sortDateArrow').textContent = sortDirectionDate ? ' ↑' : ' ↓';\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      ...
      out.write("      data.append('priority', 'medium'); // Set priority mặc định\r\n");
      out.write("      // backend tự xác định người dùng theo session; không gửi priority/customer/email\r\n");
      out.write("      fetch(ctx + '/api/support-stats', {\r\n");
      ...
      out.write("            successAlert.innerHTML = '<i class=\"fas fa-check-circle\"></i> ' + (j.message || 'Yêu cầu hỗ trợ đã được tạo thành công!') + \r\n");
      out.write("                                   '<button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button>';\r\n");
      out.write("            document.querySelector('.container').insertBefore(successAlert, document.querySelector('.support-header'));\r\n");
      out.write("            \r\n");
      out.write("            // Tự động ẩn thông báo sau 5 giây\r\n");
      out.write("            setTimeout(() => {\r\n");
      out.write("              if (successAlert.parentNode) {\r\n");
      ...
      out.write("          // Validate: require both contract and product selections when editing\r\n");
      out.write("          if (!vContract || !vProduct) return;\r\n");
      out.write("          var hasContract = vContract.value && vContract.value.trim() !== '';\r\n");
      out.write("          var hasProduct = vProduct.value && vProduct.value.trim() !== '';\r\n");
      out.write("          if (!hasContract || !hasProduct) {\r\n");
      out.write("            alert('Vui lòng chọn Hợp đồng và Sản phẩm trong hợp đồng trước khi lưu.');\r\n");
      out.write("            return;\r\n");
      out.write("          }\r\n");
      out.write("          const data = new URLSearchParams();\r\n");
      out.write("          // Ghép thông tin hợp đồng/sản phẩm vào mô tả giống form tạo mới\r\n");
      out.write("          var baseDesc = desInp.value || '';\r\n");
      out.write("          try {\r\n");
      out.write("            baseDesc = baseDesc.replace(/\\[Hợp đồng:[^\\]]+\\]\\s*/,'').replace(/\\[Sản phẩm:[^\\]]+\\]\\s*/,'').trim();\r\n");
      out.write("          } catch(e) {}\r\n");
      ...
      out.write("          data.append('priority', 'medium');\r\n");
      ...
      out.write("              const successAlert = document.createElement('div');\r\n");
      out.write("              successAlert.className = 'alert alert-success alert-dismissible fade show';\r\n");
      out.write("              successAlert.innerHTML = '<i class=\"fas fa-check-circle\"></i> ' + (j.message || 'Yêu cầu hỗ trợ đã được cập nhật thành công!') + \r\n");
      out.write("                                     '<button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button>';\r\n");
      out.write("              document.querySelector('.container').insertBefore(successAlert, document.querySelector('.support-header'));\r\n");
      out.write("              \r\n");
      out.write("              // Tự động ẩn thông báo sau 5 giây\r\n");
      ...
      out.write("                const successAlert = document.createElement('div');\r\n");
      out.write("                successAlert.className = 'alert alert-success alert-dismissible fade show';\r\n");
      out.write("                successAlert.innerHTML = '<i class=\"fas fa-check-circle\"></i> Đã hủy yêu cầu thành công!' + \r\n");
      out.write("                                       '<button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button>';\r\n");
      out.write("                document.querySelector('.container').insertBefore(successAlert, document.querySelector('.support-header'));\r\n");
      out.write("                \r\n");
