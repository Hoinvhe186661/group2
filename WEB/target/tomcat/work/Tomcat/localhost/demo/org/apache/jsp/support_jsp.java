 ...
 * Generated at: 2025-10-09 17:03:25 UTC
...
public final class support_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("      }\r\n");
      out.write("\r\n");
      out.write("      // Load contracts and filter by customer id if available\r\n");
      ...
      out.write("          const cid = (sessionCustomerId && sessionCustomerId !== 'null') ? parseInt(sessionCustomerId, 10) : null;\r\n");
      out.write("          const filtered = cid ? list.filter(it => String(it.customerId) === String(cid)) : list;\r\n");
      out.write("          filtered.forEach(it => {\r\n");
      ...
      out.write("            if (!j || !j.success) return;\r\n");
      out.write("            const list = Array.isArray(j.data)? j.data: [];\r\n");
      out.write("            const cid = (sessionCustomerId && sessionCustomerId !== 'null') ? String(sessionCustomerId) : null;\r\n");
      out.write("            const filtered = cid ? list.filter(function(x){ return String(x.customerId)===cid; }) : list;\r\n");
      out.write("            filtered.forEach(function(c){\r\n");
