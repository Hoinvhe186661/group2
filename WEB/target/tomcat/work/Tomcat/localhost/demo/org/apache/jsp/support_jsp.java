 ...
 * Generated at: 2025-11-14 04:01:29 UTC
...
public final class support_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    pageContext.setAttribute("siteAddress", headerSiteAddress);
      ...
      out.write("              </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"mb-2\" id=\"warrantyInfoContainer\" style=\"display: none;\">\r\n");
      out.write("              <div class=\"alert alert-info\" style=\"margin-bottom: 0; padding: 10px;\">\r\n");
      out.write("                <strong><i class=\"fas fa-shield-alt\"></i> Thông tin bảo hành:</strong>\r\n");
      out.write("                <div id=\"warrantyInfoText\" style=\"margin-top: 5px;\"></div>\r\n");
      out.write("              </div>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("            </select>\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"col-md-6\" id=\"v_contract_container\">\r\n");
      ...
      out.write("            </select>\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"col-md-6\" id=\"v_product_container\">\r\n");
      out.write("            <label>Sản phẩm trong hợp đồng</label>\r\n");
      out.write("            <select id=\"v_product_select\" class=\"form-control\" disabled>\r\n");
      out.write("              <option value=\"\">-- Chọn sản phẩm --</option>\r\n");
      out.write("            </select>\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"col-12\" id=\"v_external_product_container\">\r\n");
      ...
      out.write("        document.getElementById('warrantyInfoContainer').style.display = 'none';\r\n");
      ...
      out.write("              const name = item.productName ? item.productName : ('Sản phẩm #' + item.productId);\r\n");
      ...
      out.write("              // Lưu thông tin bảo hành vào dataset\r\n");
      out.write("              if (item.warrantyMonths != null) opt.dataset.warrantyMonths = item.warrantyMonths;\r\n");
      out.write("              if (item.stockOutDate != null) opt.dataset.stockOutDate = item.stockOutDate;\r\n");
      out.write("              if (item.warrantyValid != null) opt.dataset.warrantyValid = item.warrantyValid;\r\n");
      out.write("              if (item.warrantyDaysRemaining != null) opt.dataset.warrantyDaysRemaining = item.warrantyDaysRemaining;\r\n");
      out.write("              if (item.warrantyEndDate != null) opt.dataset.warrantyEndDate = item.warrantyEndDate;\r\n");
      out.write("              productSelect.appendChild(opt);\r\n");
      out.write("            });\r\n");
      out.write("          });\r\n");
      out.write("      });\r\n");
      out.write("      \r\n");
      out.write("      // Hiển thị thông tin bảo hành khi chọn sản phẩm\r\n");
      out.write("      productSelect.addEventListener('change', function(){\r\n");
      out.write("        const selectedOption = this.options[this.selectedIndex];\r\n");
      out.write("        const warrantyContainer = document.getElementById('warrantyInfoContainer');\r\n");
      out.write("        const warrantyText = document.getElementById('warrantyInfoText');\r\n");
      out.write("        \r\n");
      out.write("        if (!selectedOption || !selectedOption.value) {\r\n");
      out.write("          warrantyContainer.style.display = 'none';\r\n");
      out.write("          return;\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        const warrantyMonths = selectedOption.dataset.warrantyMonths;\r\n");
      out.write("        const stockOutDate = selectedOption.dataset.stockOutDate;\r\n");
      out.write("        const warrantyValid = selectedOption.dataset.warrantyValid;\r\n");
      out.write("        const warrantyDaysRemaining = selectedOption.dataset.warrantyDaysRemaining;\r\n");
      out.write("        const warrantyEndDate = selectedOption.dataset.warrantyEndDate;\r\n");
      out.write("        \r\n");
      out.write("        if (warrantyMonths && stockOutDate && warrantyValid !== undefined) {\r\n");
      out.write("          warrantyContainer.style.display = 'block';\r\n");
      out.write("          let html = '';\r\n");
      out.write("          \r\n");
      out.write("          if (warrantyValid === 'true' || warrantyValid === true) {\r\n");
      out.write("            const daysRemaining = parseInt(warrantyDaysRemaining) || 0;\r\n");
      out.write("            html += '<span style=\"color: #28a745;\"><i class=\"fas fa-check-circle\"></i> <strong>Còn bảo hành</strong></span><br>';\r\n");
      out.write("            html += 'Thời gian bảo hành: <strong>' + warrantyMonths + ' tháng</strong><br>';\r\n");
      out.write("            html += 'Ngày xuất kho: <strong>' + (stockOutDate ? new Date(stockOutDate).toLocaleDateString('vi-VN') : 'Chưa có') + '</strong><br>';\r\n");
      out.write("            html += 'Ngày hết hạn bảo hành: <strong>' + (warrantyEndDate || 'N/A') + '</strong><br>';\r\n");
      out.write("            html += 'Còn lại: <strong style=\"color: #28a745;\">' + daysRemaining + ' ngày</strong>';\r\n");
      out.write("            warrantyContainer.querySelector('.alert').className = 'alert alert-success';\r\n");
      out.write("          } else {\r\n");
      out.write("            html += '<span style=\"color: #dc3545;\"><i class=\"fas fa-times-circle\"></i> <strong>Hết bảo hành</strong></span><br>';\r\n");
      out.write("            html += 'Thời gian bảo hành: <strong>' + warrantyMonths + ' tháng</strong><br>';\r\n");
      out.write("            html += 'Ngày xuất kho: <strong>' + (stockOutDate ? new Date(stockOutDate).toLocaleDateString('vi-VN') : 'Chưa có') + '</strong><br>';\r\n");
      out.write("            html += 'Ngày hết hạn bảo hành: <strong>' + (warrantyEndDate || 'N/A') + '</strong><br>';\r\n");
      out.write("            const daysOverdue = Math.abs(parseInt(warrantyDaysRemaining) || 0);\r\n");
      out.write("            html += 'Đã hết hạn: <strong style=\"color: #dc3545;\">' + daysOverdue + ' ngày</strong>';\r\n");
      out.write("            warrantyContainer.querySelector('.alert').className = 'alert alert-warning';\r\n");
      out.write("          }\r\n");
      out.write("          \r\n");
      out.write("          warrantyText.innerHTML = html;\r\n");
      out.write("        } else if (warrantyMonths) {\r\n");
      out.write("          warrantyContainer.style.display = 'block';\r\n");
      out.write("          warrantyContainer.querySelector('.alert').className = 'alert alert-info';\r\n");
      out.write("          warrantyText.innerHTML = 'Thời gian bảo hành: <strong>' + warrantyMonths + ' tháng</strong><br>' +\r\n");
      out.write("                                 'Ngày xuất kho: <strong>Chưa có</strong> (Sản phẩm chưa được xuất kho)';\r\n");
      out.write("        } else {\r\n");
      out.write("          warrantyContainer.style.display = 'none';\r\n");
      out.write("        }\r\n");
      out.write("      });\r\n");
      ...
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    function getCategoryText(category) {\r\n");
      out.write("      const categoryMap = {\r\n");
      out.write("        'technical': 'Kỹ thuật',\r\n");
      out.write("       \r\n");
      out.write("        'general': 'Chung',\r\n");
      out.write("        \r\n");
      out.write("      };\r\n");
      out.write("      return categoryMap[category] || category || 'N/A';\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      ...
      out.write("        const categoryText = getCategoryText(it.category);\r\n");
      out.write("        tr.innerHTML = '<td>'+ sequenceNumber +'</td><td>'+ categoryText +'</td><td>'+ displaySubject +'</td><td>'+ created +'</td><td><span class=\"badge ' + statusClass + '\">' + status + '</span></td><td><a href=\"#\" class=\"view-link me-2\" data-id=\"'+ (it.id||'') +'\">Xem</a> ' + cancelButton + feedbackButton + '</td>';\r\n");
      ...
      out.write("      \r\n");
      out.write("      // Reset hiển thị các trường về mặc định (hiển thị tất cả)\r\n");
      out.write("      var contractContainer = document.getElementById('v_contract_container');\r\n");
      out.write("      var productContainer = document.getElementById('v_product_container');\r\n");
      out.write("      var externalProductContainer = document.getElementById('v_external_product_container');\r\n");
      out.write("      if (contractContainer) contractContainer.style.display = 'block';\r\n");
      out.write("      if (productContainer) productContainer.style.display = 'block';\r\n");
      out.write("      if (externalProductContainer) externalProductContainer.style.display = 'block';\r\n");
      out.write("      \r\n");
      ...
      out.write("            \r\n");
      out.write("            // Lấy các container để ẩn/hiện\r\n");
      out.write("            var contractContainer = document.getElementById('v_contract_container');\r\n");
      out.write("            var productContainer = document.getElementById('v_product_container');\r\n");
      out.write("            var externalProductContainer = document.getElementById('v_external_product_container');\r\n");
      out.write("            \r\n");
      out.write("            // Kiểm tra và ẩn/hiện các trường tương ứng\r\n");
      out.write("            if (contractLabel && productLabel) {\r\n");
      out.write("              // Có hợp đồng và sản phẩm -> ẩn sản phẩm ngoài\r\n");
      out.write("              if (externalProductContainer) externalProductContainer.style.display = 'none';\r\n");
      out.write("              if (contractContainer) contractContainer.style.display = 'block';\r\n");
      out.write("              if (productContainer) productContainer.style.display = 'block';\r\n");
      out.write("            } else if (externalProductLabel) {\r\n");
      out.write("              // Có sản phẩm ngoài -> ẩn hợp đồng và sản phẩm trong hợp đồng\r\n");
      out.write("              if (contractContainer) contractContainer.style.display = 'none';\r\n");
      out.write("              if (productContainer) productContainer.style.display = 'none';\r\n");
      out.write("              if (externalProductContainer) externalProductContainer.style.display = 'block';\r\n");
      out.write("            } else {\r\n");
      out.write("              // Không có gì -> hiển thị tất cả\r\n");
      out.write("              if (contractContainer) contractContainer.style.display = 'block';\r\n");
      out.write("              if (productContainer) productContainer.style.display = 'block';\r\n");
      out.write("              if (externalProductContainer) externalProductContainer.style.display = 'block';\r\n");
      out.write("            }\r\n");
      ...
      out.write("                      var opt = document.createElement('option');\r\n");
      out.write("                      opt.value = item.productId;\r\n");
      out.write("                      var name = item.productName ? item.productName : ('Sản phẩm #' + item.productId);\r\n");
      out.write("                      opt.textContent = name;\r\n");
      ...
      out.write("      }\r\n");
      out.write("      \r\n");
      out.write("      // Hàm cập nhật ẩn/hiện các trường dựa trên giá trị hiện tại\r\n");
      out.write("      function updateFieldVisibility() {\r\n");
      out.write("        var contractContainer = document.getElementById('v_contract_container');\r\n");
      out.write("        var productContainer = document.getElementById('v_product_container');\r\n");
      out.write("        var externalProductContainer = document.getElementById('v_external_product_container');\r\n");
      out.write("        \r\n");
      ...
      out.write("          if (contractContainer) contractContainer.style.display = 'block';\r\n");
      out.write("          if (productContainer) productContainer.style.display = 'block';\r\n");
      out.write("          if (vExternalProduct) vExternalProduct.value = ''; // Xóa giá trị sản phẩm ngoài\r\n");
      out.write("        } else if (hasExternalProduct) {\r\n");
      out.write("          // Có sản phẩm ngoài -> ẩn hợp đồng và sản phẩm trong hợp đồng\r\n");
      out.write("          if (contractContainer) contractContainer.style.display = 'none';\r\n");
      out.write("          if (productContainer) productContainer.style.display = 'none';\r\n");
      out.write("          if (externalProductContainer) externalProductContainer.style.display = 'block';\r\n");
      out.write("          if (vContract) vContract.selectedIndex = 0; // Reset hợp đồng\r\n");
      out.write("          if (vProduct) { vProduct.innerHTML = '<option value=\"\">-- Chọn sản phẩm --</option>'; vProduct.disabled = true; } // Reset sản phẩm\r\n");
      out.write("        } else {\r\n");
      out.write("          // Không có gì -> hiển thị tất cả\r\n");
      out.write("          if (contractContainer) contractContainer.style.display = 'block';\r\n");
      out.write("          if (productContainer) productContainer.style.display = 'block';\r\n");
      ...
      out.write("              if (!id) {\r\n");
      out.write("                updateFieldVisibility();\r\n");
      out.write("                return;\r\n");
      out.write("              }\r\n");
      out.write("              fetch(ctx + '/api/contract-items?contractId=' + encodeURIComponent(id), { headers: { 'Accept': 'application/json' } })\r\n");
      out.write("                .then(function(r){ return r.json(); })\r\n");
      ...
      out.write("            };\r\n");
      out.write("          }\r\n");
      out.write("          // Cập nhật ẩn/hiện khi thay đổi sản phẩm trong hợp đồng\r\n");
      out.write("          if (on && vProduct) {\r\n");
      out.write("            vProduct.onchange = function(){\r\n");
      out.write("              updateFieldVisibility();\r\n");
      out.write("            };\r\n");
      out.write("          }\r\n");
      out.write("          // Cập nhật ẩn/hiện khi thay đổi sản phẩm ngoài\r\n");
      out.write("          if (on && vExternalProduct) {\r\n");
      out.write("            vExternalProduct.oninput = function(){\r\n");
      out.write("              updateFieldVisibility();\r\n");
      out.write("            };\r\n");
      out.write("          }\r\n");
      out.write("        };\r\n");
