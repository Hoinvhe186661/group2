 ...
 * Generated at: 2025-11-05 16:10:53 UTC
...
public final class support_005fmanagement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (!"customer_support".equals(userRole) && !"admin".equals(userRole)) {
      ...
      out.write("                            </select>\r\n");
      out.write("                            <small class=\"text-muted\">Chỉ có thể chuyển tiếp đến trưởng phòng kỹ thuật</small>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        \r\n");
      out.write("                        <div class=\"form-group\">\r\n");
      ...
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("            // Xử lý click nút Chuyển tiếp - CHỈ cho phép một ticket tại một thời điểm\r\n");
      out.write("            $(document).on('click', '.forward-ticket-btn', function(e) {\r\n");
      out.write("                e.preventDefault();\r\n");
      out.write("                e.stopPropagation();\r\n");
      out.write("                \r\n");
      out.write("                // Kiểm tra nếu đang có forward đang xử lý\r\n");
      out.write("                if (isForwardingInProgress) {\r\n");
      out.write("                    alert('Vui lòng đợi hoàn tất việc chuyển tiếp hiện tại trước khi chuyển tiếp ticket khác!');\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                // Kiểm tra nếu nút này đã bị disable\r\n");
      out.write("                if ($(this).prop('disabled')) {\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                // Lấy ticket ID từ nút được click - CHỈ lấy ID của nút này\r\n");
      out.write("                var ticketId = $(this).data('ticket-id');\r\n");
      out.write("                var ticketNumber = $(this).data('ticket-number');\r\n");
      out.write("                \r\n");
      out.write("                // Kiểm tra ticketId có hợp lệ không\r\n");
      out.write("                if (!ticketId) {\r\n");
      out.write("                    alert('Lỗi: Không tìm thấy ID ticket');\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                // Set flag NGAY LẬP TỨC để ngăn chặn forward ticket khác\r\n");
      out.write("                isForwardingInProgress = true;\r\n");
      out.write("                \r\n");
      out.write("                // Disable TẤT CẢ các nút chuyển tiếp NGAY LẬP TỨC\r\n");
      out.write("                $('.forward-ticket-btn').prop('disabled', true).css('opacity', '0.6');\r\n");
      out.write("                \r\n");
      out.write("                // CHỈ mở modal cho ticket ID này\r\n");
      out.write("                showForwardModal(ticketId, ticketNumber);\r\n");
      out.write("                \r\n");
      out.write("                // Re-enable các nút sau khi modal đóng (nếu không forward)\r\n");
      out.write("                $('#forwardTicketModal').off('hidden.bs.modal').on('hidden.bs.modal', function() {\r\n");
      out.write("                    if (!isForwardingInProgress) {\r\n");
      out.write("                        $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("                \r\n");
      out.write("                return false;\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        // Hiển thị modal chuyển tiếp - CHỈ cho phép một ticket tại một thời điểm\r\n");
      out.write("        var isForwardingInProgress = false; // Flag để ngăn chặn forward nhiều ticket cùng lúc\r\n");
      out.write("        \r\n");
      out.write("        function showForwardModal(ticketId, ticketNumber) {\r\n");
      out.write("            // Đảm bảo chỉ xử lý một ticket ID cụ thể\r\n");
      out.write("            console.log('showForwardModal called for ticket ID:', ticketId);\r\n");
      out.write("            \r\n");
      out.write("            // Kiểm tra ticket status trước khi mở modal\r\n");
      out.write("            $.ajax({\r\n");
      out.write("                url: 'support-detail',\r\n");
      out.write("                type: 'GET',\r\n");
      out.write("                data: { id: ticketId }, // CHỈ gửi ticket ID này\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success: function(response) {\r\n");
      out.write("                    if (response.success && response.data) {\r\n");
      out.write("                        var ticket = response.data;\r\n");
      out.write("                        var status = ticket.status;\r\n");
      out.write("                        var assignedTo = ticket.assignedTo;\r\n");
      out.write("                        \r\n");
      out.write("                        // Kiểm tra nếu ticket đã được forward (in_progress và đã có assignedTo)\r\n");
      out.write("                        // assignedTo có thể là số (ID) hoặc null/undefined/empty string\r\n");
      out.write("                        var hasAssignedTo = assignedTo != null && assignedTo !== '' && assignedTo !== 0 && assignedTo !== '0';\r\n");
      out.write("                        if (status === 'in_progress' && hasAssignedTo) {\r\n");
      out.write("                            alert('Yêu cầu này đã được chuyển tiếp và đang xử lý rồi.\\n\\nKhông thể chuyển tiếp lại!');\r\n");
      out.write("                            // Reset flag và re-enable các nút nếu không forward được\r\n");
      out.write("                            isForwardingInProgress = false;\r\n");
      out.write("                            $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        \r\n");
      out.write("                        // Kiểm tra nếu ticket đã resolved hoặc closed\r\n");
      out.write("                        if (status === 'resolved' || status === 'closed') {\r\n");
      out.write("                            alert('Yêu cầu này đã được giải quyết hoặc đóng.\\n\\nKhông thể chuyển tiếp!');\r\n");
      out.write("                            // Reset flag và re-enable các nút nếu không forward được\r\n");
      out.write("                            isForwardingInProgress = false;\r\n");
      out.write("                            $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        \r\n");
      out.write("                        // Ticket hợp lệ, mở modal - CHỈ cho ticket ID này\r\n");
      out.write("                        // Lấy độ ưu tiên hiện tại của ticket (nếu có)\r\n");
      out.write("                        var currentPriority = ticket.priority || 'medium';\r\n");
      out.write("                        \r\n");
      out.write("                        $('#forward_ticket_id').val(ticketId); // CHỈ set ticket ID này (một ID duy nhất)\r\n");
      out.write("                        $('#forward_ticket_number').text(ticketNumber || '#' + ticketId);\r\n");
      out.write("                        $('#forward_priority').val(currentPriority); // Set độ ưu tiên hiện tại, người dùng có thể sửa\r\n");
      out.write("                        $('#forward_assigned_to').html('<option value=\"\">-- Đang tải --</option>');\r\n");
      out.write("                        $('#btnForwardTicket').prop('disabled', false); // Đảm bảo button enabled\r\n");
      out.write("                        \r\n");
      out.write("                        // Load danh sách CHỈ trưởng phòng kỹ thuật\r\n");
      out.write("                        $.ajax({\r\n");
      ...
      out.write("                            success: function(response) {\r\n");
      out.write("                                if (response.success && response.data) {\r\n");
      out.write("                                    var options = '<option value=\"\">-- Chọn trưởng phòng kỹ thuật --</option>';\r\n");
      out.write("                                    if (response.data.length === 0) {\r\n");
      out.write("                                        options = '<option value=\"\">Không có trưởng phòng kỹ thuật</option>';\r\n");
      out.write("                                        alert('Không có trưởng phòng kỹ thuật để chuyển tiếp!');\r\n");
      out.write("                                        // Reset flag nếu không có trưởng phòng\r\n");
      out.write("                                        isForwardingInProgress = false;\r\n");
      out.write("                                        $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                                    } else {\r\n");
      out.write("                                        $.each(response.data, function(index, staff) {\r\n");
      out.write("                                            // CHỈ hiển thị trưởng phòng kỹ thuật\r\n");
      ...
      out.write("                                    alert('Không thể tải danh sách trưởng phòng kỹ thuật');\r\n");
      out.write("                                    // Reset flag nếu có lỗi\r\n");
      out.write("                                    isForwardingInProgress = false;\r\n");
      out.write("                                    $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                                }\r\n");
      out.write("                            },\r\n");
      out.write("                            error: function() {\r\n");
      out.write("                                $('#forward_assigned_to').html('<option value=\"\">Lỗi tải danh sách</option>');\r\n");
      out.write("                                alert('Lỗi kết nối khi tải danh sách trưởng phòng kỹ thuật');\r\n");
      out.write("                                // Reset flag nếu có lỗi\r\n");
      out.write("                                isForwardingInProgress = false;\r\n");
      out.write("                                $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                            }\r\n");
      ...
      out.write("                        // Reset flag và re-enable các nút nếu có lỗi\r\n");
      out.write("                        isForwardingInProgress = false;\r\n");
      out.write("                        $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      out.write("                error: function() {\r\n");
      out.write("                    alert('Lỗi kết nối khi kiểm tra trạng thái ticket!');\r\n");
      out.write("                    // Reset flag và re-enable các nút nếu có lỗi\r\n");
      out.write("                    isForwardingInProgress = false;\r\n");
      out.write("                    $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                }\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        // Chuyển tiếp ticket đến bộ phận kỹ thuật - CHỈ cho phép một ticket tại một thời điểm\r\n");
      out.write("        function forwardTicket() {\r\n");
      out.write("            // Kiểm tra nếu đang có forward đang xử lý\r\n");
      out.write("            if (isForwardingInProgress) {\r\n");
      out.write("                alert('Đang xử lý chuyển tiếp ticket khác. Vui lòng đợi!');\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            // Lấy ticket ID từ form - CHỈ một ID\r\n");
      ...
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            // Đảm bảo ticketId là một số duy nhất, không phải array hoặc nhiều ID\r\n");
      out.write("            if (Array.isArray(ticketId) || (typeof ticketId === 'string' && ticketId.includes(','))) {\r\n");
      out.write("                alert('Lỗi: Chỉ có thể chuyển tiếp một ticket tại một thời điểm!');\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      ...
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            // Set flag để ngăn chặn forward nhiều ticket cùng lúc\r\n");
      out.write("            isForwardingInProgress = true;\r\n");
      out.write("            \r\n");
      out.write("            // Disable button và đóng modal để ngăn chặn click nhiều lần\r\n");
      out.write("            $('#btnForwardTicket').prop('disabled', true).html('<i class=\"fa fa-spinner fa-spin\"></i> Đang xử lý...');\r\n");
      out.write("            $('#forwardTicketModal').modal('hide'); // Đóng modal ngay để tránh click nhiều lần\r\n");
      out.write("            \r\n");
      out.write("            // CHỈ gửi một ticket ID\r\n");
      out.write("            console.log('Forwarding ticket ID:', ticketId);\r\n");
      out.write("            \r\n");
      out.write("            var data = {\r\n");
      out.write("                action: 'forward',\r\n");
      out.write("                id: ticketId, // CHỈ một ID\r\n");
      ...
      out.write("                type: 'POST',\r\n");
      out.write("                data: $.param(data), // CHỈ gửi một ticket ID\r\n");
      out.write("                contentType: 'application/x-www-form-urlencoded; charset=UTF-8',\r\n");
      out.write("                dataType: 'json',\r\n");
      out.write("                success: function(response) {\r\n");
      out.write("                    if (response.success) {\r\n");
      out.write("                        alert('✓ ' + response.message);\r\n");
      out.write("                        // Reset flag trước khi reload\r\n");
      out.write("                        isForwardingInProgress = false;\r\n");
      out.write("                        // Reload trang sau khi forward thành công\r\n");
      out.write("                        location.reload();\r\n");
      out.write("                    } else {\r\n");
      out.write("                        alert('✗ ' + response.message);\r\n");
      out.write("                        // Reset flag nếu thất bại để có thể thử lại\r\n");
      out.write("                        isForwardingInProgress = false;\r\n");
      out.write("                        $('.forward-ticket-btn').prop('disabled', false).css('opacity', '1');\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      ...
      out.write("                },\r\n");
      out.write("                complete: function() {\r\n");
      out.write("                    // Enable button (nhưng không cần vì đã reload trang khi success)\r\n");
