                                        ...
                                        <div class="banner-content">
                                            ...
                                            <div class="banner-right">
                                                <div class="company-title">
                                                    <h1>
                                                        <%= pageContext.getAttribute("siteName") !=null ?
                                                            pageContext.getAttribute("siteName")
                                                            : "CÔNG TY CP CHẾ TẠO MÁY HOÀ LẠC" %>
                                                    </h1>
                                                </div>
                                                <div class="hotline-info">
                                                    <span class="hotline-label">HOTLINE</span>
                                                    <span class="hotline-number">
                                                        <%= pageContext.getAttribute("sitePhone") !=null ?
                                                            pageContext.getAttribute("sitePhone") : "0989 888 999" %>
                                                    </span>
                                                </div>
                                                <div class="website-info">
                                                    <span>
                                                        <%= pageContext.getAttribute("siteEmail") !=null ?
                                                            pageContext.getAttribute("siteEmail")
                                                            : "contact@example.com" %>
                                                    </span>
                                                </div>
                                            </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 text-center mb-5">
                                        <h2 class="main-title">
                                            <%= pageContext.getAttribute("siteName") !=null ?
                                                pageContext.getAttribute("siteName") : "CÔNG TY CP CHẾ TẠO MÁY HOÀ LẠC"
                                                %>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div class="content-row">
                                    <div class="left-content-block">
                                        <div class="quote-block">
                                            <div class="quote-text">
                                                "Chúng tôi chưa là tốt nhất nhưng sẽ nỗ lực cao nhất vì niềm tin của
                                                bạn"
                                            </div>
                                            <div class="quote-text">
                                    ...
                                    <div class="right-content-block">
                                        <div class="info-content">
                                            <p>Máy phát điện Hoà Lạc là nhà nhập khẩu, lắp ráp, phân phối, bảo trì, bảo
                                                hành động cơ, đầu phát và tổ máy phát điện chính thức của các hãng sản
                                                xuất máy phát điện uy tín trên thế giới như: CUMMINS, DENYO, DOOSAN,
                                                MITSUBISHI, KOMATSU, YUCHAI,…</p>

                                            <p>Chúng tôi cung cấp máy phát điện phù hợp sử dụng cho các nhà máy, công
                                                trường, trang trại chăn nuôi, bệnh viện, khách sạn, khu du lịch nghỉ
                                                dưỡng, chung cư cao ốc, tòa nhà văn phòng …</p>

                                            <p>Với phương châm: <strong>Chuyên Nghiệp + Kinh Nghiệm => Giải Pháp Hợp
                                                    Lý.</strong></p>

                                            <p>Quý Khách Hàng sẽ hoàn toàn yên tâm khi sử dụng các dịch vụ trọn gói của
                                                chúng tôi.</p>

                                            <div class="learn-more-btn">
                                                <a href="contact.jsp" class="btn">Tìm hiểu thêm</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                ...
                                <div class="product-grid">
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-info">
                                            <p>Chúng tôi cung cấp tới Quý khách hàng những sản phẩm máy phát điện nhập
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-info">
                                            <p>Dòng sản phẩm máy phát điện lắp ráp trong nước sử dụng động cơ của các
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-info">
                                            <p>Máy phát điện Hoà Lạc chuyên cung cấp dòng sản phẩm máy phát điện cũ với
                            ...
                            <div class="container">
                                <div class="row align-items-center g-4">
                                    <div class="col-lg-6">
                                        ...
                                        <p><span class="highlight">💡 HOÀ LẠC ELECTRIC</span> hoạt động với phương châm
                                            “Uy tín làm nên thương hiệu – Sự hài lòng của bạn là thành công của chúng
                                            tôi!”</p>
                                        <p>Chúng tôi mang đến các giải pháp máy phát điện và thiết bị điện công nghiệp
                                            ổn định, chất lượng cao với mức chi phí hợp lý – lựa chọn lý tưởng cho các
                                            doanh nghiệp đang tìm kiếm nguồn điện tin cậy để bảo đảm hoạt động sản xuất
                                            – kinh doanh.</p>
                                        <p>Sở hữu đội ngũ kỹ thuật viên giàu kinh nghiệm, dịch vụ hậu mãi tận tâm cùng
                                            hệ thống kho hàng quy mô lớn tại Hà Nội và TP. Hồ Chí Minh, HOÀ LẠC ELECTRIC
                                            luôn sẵn sàng đồng hành cùng sự phát triển bền vững của quý khách hàng.</p>
                                        <p>Chúng tôi rất mong nhận được sự tin tưởng, ủng hộ và hợp tác của Quý khách
                                            hàng và Đối tác để HOÀ LẠC ELECTRIC có cơ hội cung cấp những sản phẩm chất
                                            lượng, giá cả cạnh tranh và dịch vụ chuyên nghiệp, tận tâm.</p>
                                    </div>
                                    <div class="col-lg-6 text-center">
                                        <img src="images/sanpham1.jpg" class="img-fluid rounded-3" alt="Why trust us"
